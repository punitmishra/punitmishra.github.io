    ...
    <section class="pt-32 pb-8 px-6">
      <div class="max-w-4xl mx-auto">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 class="text-4xl md:text-5xl font-heading font-bold text-gray-900 dark:text-white mb-2">Resume</h1>
            <p class="text-gray-600 dark:text-gray-400">Professional experience and qualifications</p>
          </div>
          <button
            @click="downloadPDF"
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors shadow-sm"
          >
