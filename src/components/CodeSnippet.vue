...
<template>
  <div class="relative group bg-slate-900 rounded-2xl overflow-hidden border border-slate-700/50 shadow-xl">
    <div v-if="title" class="px-4 py-2 bg-slate-800 border-b border-slate-700/50 flex items-center justify-between">
      ...
      <button
        ...
        title="Copy code"
      >
        <BaseIcon :path="copied ? mdiCheck : mdiContentCopy" size="18" />
      </button>
    </div>
