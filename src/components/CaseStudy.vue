...
<template>
  <article class="case-study">
    ...
    <header class="relative mb-16">
      ...
      <div
        v-else
        class="w-full aspect-[21/9] bg-gradient-to-br from-accent/20 to-accent-light/20 rounded-3xl flex items-center justify-center"
      >
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="space-y-4">
          <div v-if="project.role">
            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">
              Role
            </h4>
    ...
    <section class="mb-16 grid md:grid-cols-2 gap-8">
      <div
        ...
        class="bg-red-50 dark:bg-red-900/10 rounded-2xl p-8"
      >
      ...
      <div
        ...
        class="bg-green-50 dark:bg-green-900/10 rounded-2xl p-8"
      >
    ...
    >
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div
            v-if="image.caption"
            class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
          >
