...
<template>
  <div v-if="hasError" class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-6">
    <div class="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 text-center">
      <div class="w-16 h-16 bg-red-100 dark:bg-red-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
        <BaseIcon :path="mdiAlertCircle" size="32" class="text-red-600 dark:text-red-400" />
      </div>
      ...
      >
        <BaseIcon :path="mdiReload" size="20" />
        <span>Try Again</span>
      </button>
